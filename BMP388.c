...
HAL_StatusTypeDef BMP388_StartNormalModeFIFO(BMP388_HandleTypeDef *bmp){
	...
	uint8_t pwr_ctrl 	  =   BMP3_PWR_CTRL_PRESS_ON
					   		| BMP3_PWR_CTRL_TEMP_ON
					   		| BMP3_PWR_CTRL_MODE_NORMAL;

	uint8_t fifo_config_1 =   BMP3_FIFO_CONFIG_1_FIFO_MODE_ON
							| BMP3_FIFO_CONFIG_1_FIFO_STOP_ON_FULL_ON
                            | BMP3_FIFO_CONFIG_1_FIFO_TIME_EN_OFF
							| BMP3_FIFO_CONFIG_1_FIFO_PRESS_EN_ON
